...
<?php
	...
	<div class="text-center col-lg-12">
		<div class="btn-group btn-group-justified">
			...
			<?php } ?>
      <!-- Show further information section if we are on the standardisation section -->
      <?php if ($nextSection == '') { ?>
          <div class="btn-group" role="group">
              <button type="submit" class="btn btn-primary" onclick="$('form').attr('action', 'furtherInformation');">Next</button>
          </div>
      <?php } ?>
		</div>
	</div>
